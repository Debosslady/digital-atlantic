...
export const metadata = {
  ...
  openGraph: {
    ...
    images: ["/assets/images/og-about.jpg"], // optional – add real OG image later
  },
};
...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="py-6 md:py-12">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative w-full min-h-[250px] md:min-h-[450px] lg:min-h-[500px] rounded-2xl overflow-hidden shadow-2xl border border-primary/20">
                <Image
                    src="/assets/images/monga.jpg"
                    ...
                    priority={false}          // not needed on about page usually
                    quality={85}
                /> 
            </div>
          </div>
      ...
      <section className="py-8 bg-secondary/5 border-t border-secondary/10">
